...
public class NameTokens {
	...
	public static final String wyswietlKlientow = "wyswietlKlientow";
	...
	public static String getWyswietlKlientow() {
		return wyswietlKlientow;
	}

	public static String getDodajKlienta() {
		return dodajKlienta;
	}
